...
class MCA(ca.CA):
    ...
    def fit(self, X, y=None):
        ...
        #ohe = OneHotEncoder(sparse=True, dtype=np.uint8, categories='auto')
        #ohe = OneHotEncoder(handle_unknown='ignore')
        #self.one_hot_ = ohe.fit(X)
        self.one_hot_ = one_hot.OneHotEncoder().fit(X)
        print('one hot passed! ')
...
#     def _coordinates(self, X, ax=None, figsize=(6, 6), x_component=0, y_component=1,
